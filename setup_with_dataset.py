#!/usr/bin/env python3
"""
Complete setup script for Eye Disease Detection System
This script will set up both frontend and backend, and download the Kaggle dataset
"""
...
def setup_ml_model():
    ...
    python_path = venv_dir / "Scripts" / "python.exe" if platform.system() == "Windows" else venv_dir / "bin" / "python"
